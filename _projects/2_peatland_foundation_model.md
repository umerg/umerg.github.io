...
The deployed system delivers a ~10× mIoU improvement over the incumbent DEFRA-backed baseline and is in production use at [Calterra](https://calterra.io/) for ecosystem monitoring.
